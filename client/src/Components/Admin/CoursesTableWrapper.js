...
const CoursesTableWrapper = ({ handleSort, sortConfig, sortedCourses, countTotalClasses, countTotalStudents, countTotalSubjects, countTotalTeachers, toggleAddItem, toggleDeleteCourse, teachers, students, subjects, classes, actionMenuRefs, visibleActionCardId, handleActionVisible }) => {
  return (
